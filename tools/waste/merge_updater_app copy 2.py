...
combined_hex = os.path.join(output_dir, "firmware_combined.hex")
combined_bin = os.path.join(output_dir, "firmware_combined.bin")
dfu_zip_path = os.path.join(output_dir, "firmware_dfu.zip")
