...
project_dir = env.get("PROJECT_DIR", os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
hex_path = os.path.join(project_dir, ".pio", "build", "combined", "firmware.hex")
bin_path = os.path.join(project_dir, ".pio", "build", "combined", "firmware.bin")
