...
class MainActivity : AppCompatActivity() {
    ...
    private var actualRpmIdx :Int = 0
    ...
    fun onTapRms0(view: View) { actualRpmIdx = 0 }
    fun onTapRms1(view: View) { actualRpmIdx = 1 }
    fun onTapRms2(view: View) { actualRpmIdx = 2 }
    fun onTapRms3(view: View) { actualRpmIdx = 3 }
    fun onTapRms4(view: View) { actualRpmIdx = 4 }
    fun onTapRms5(view: View) { actualRpmIdx = 5 }
    fun onTapRms6(view: View) { actualRpmIdx = 6 }
    ...
    private fun updateControls(){
        ...
        textViewRpm1.text = String.format("%.0f rpm: ", sensor.rpm[1])
        textViewRpm2.text = String.format("%.0f rpm: ", sensor.rpm[2])
        textViewRpm3.text = String.format("%.0f rpm: ", sensor.rpm[3])
        textViewRpm4.text = String.format("%.0f rpm: ", sensor.rpm[4])
        textViewRpm5.text = String.format("%.0f rpm: ", sensor.rpm[5])
        textViewRpm6.text = String.format("%.0f rpm: ", sensor.rpm[6])
    }
    ...
    private fun updateData() {
        ...
        textViewRpm0.text = String.format("%.0f rpm: ", sensor.rpm[0])
