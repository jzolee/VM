...
class BLEManager private constructor(
    ...
    companion object {
        ...
        private val CONTROL_CHARACTERISTIC_UUID =
            UUID.fromString("96540001-d6a3-4d5b-8145-e5855fd090a7")
        private val STATUS_CHARACTERISTIC_UUID =
            UUID.fromString("96540002-d6a3-4d5b-8145-e5855fd090a7")
        private val DATA_CHARACTERISTIC_UUID =
            UUID.fromString("96540003-d6a3-4d5b-8145-e5855fd090a7")
