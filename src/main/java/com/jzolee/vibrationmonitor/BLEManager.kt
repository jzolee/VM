...
class BLEManager private constructor(
    ...
    private fun registerAppStateReceiver() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                ...
                // For older versions, we still need to specify the flag
                context.registerReceiver(
                    appStateReceiver,
                    filter,
            ...
            logCallback("Error registering receiver: ${e.message}")
        }
    }
    ...
    private fun scheduleBackgroundReconnect() {
        ...
        val workRequest = androidx.work.OneTimeWorkRequestBuilder<BLEReconnectWorker>()
